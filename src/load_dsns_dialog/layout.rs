...
#[derive(Default)]
pub(super) struct LoadDsnsDialogLayout {
    root_layout: nwg::FlexboxLayout,
    buttons_layout: nwg::FlexboxLayout,
}

impl ui::Layout<LoadDsnsDialogControls> for LoadDsnsDialogLayout {
    fn build(&self, c: &LoadDsnsDialogControls) -> Result<(), nwg::NwgError> {
